...
class MacroAssembler : public MacroAssemblerSpecific
{
  ...
  public:
    ...
    inline void and64(Register64 src, Register64 dest) DEFINED_ON(x86, arm, mips32);
    ...
    inline void add64(Imm64 imm, Register64 dest) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void sub64(Register64 src, Register64 dest) DEFINED_ON(x86, x64, arm, mips32);
    inline void sub64(Imm64 imm, Register64 dest) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void neg64(Register64 reg) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void rshift64Arithmetic(Imm32 imm, Register64 dest) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void lshift64(Register shift, Register64 srcDest) DEFINED_ON(x86, x64, arm, mips32);
    inline void rshift64(Register shift, Register64 srcDest) DEFINED_ON(x86, x64, arm, mips32);
    inline void rshift64Arithmetic(Register shift, Register64 srcDest) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void clz64(Register64 src, Register dest) DEFINED_ON(x86, x64, arm, mips32);
    inline void ctz64(Register64 src, Register dest) DEFINED_ON(x86, x64, arm, mips32);

    // On x86_shared, temp may be Invalid only if the chip has the POPCNT instruction.
    // On ARM, temp may never be Invalid.
    inline void popcnt32(Register src, Register dest, Register temp) DEFINED_ON(arm, x86_shared, mips32);

    // temp may be invalid only if the chip has the POPCNT instruction.
    inline void popcnt64(Register64 src, Register64 dest, Register temp) DEFINED_ON(x86, x64, arm, mips32);
    ...
    inline void branch64(Condition cond, Register64 lhs, Imm64 val, Label* success,
                         Label* fail = nullptr) DEFINED_ON(x86, x64, arm, mips32);

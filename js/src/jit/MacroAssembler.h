...
class MacroAssembler : public MacroAssemblerSpecific
{
  ...
  public:
    ...
    inline void and64(Register64 src, Register64 dest) DEFINED_ON(x86, arm, mips64);
    ...
    inline void add64(Imm64 imm, Register64 dest) DEFINED_ON(x86, x64, arm, mips64, mips32);
    ...
    inline void sub64(Register64 src, Register64 dest) DEFINED_ON(x86, x64, arm, mips64, mips32);
    inline void sub64(Imm64 imm, Register64 dest) DEFINED_ON(x86, x64, arm, mips64, mips32);
